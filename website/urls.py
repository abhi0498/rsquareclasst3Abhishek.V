...
urlpatterns = [
    ...
    path('student/add-guardian/<int:pk>', views.student_guardian_add, name='student-guardian-add'),
     path('student/view-guardian/<int:pk>', views.student_guardian, name='student-guardian-view'),
